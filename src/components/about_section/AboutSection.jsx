...
const AboutSection = () => {
  return (
    <>
      <div className="about-section px-5 max-w-[1400px] mx-auto mt-10 py-10">
        {/* bottom */}
          ...
          <div data-aos="fade-right" className="md:w-[60%] w-full">
            ...
            <div className="mt-7 flex flex-col gap-2 items-center flex-wrap md:flex-row">
              <a
                ...
                download="cv-josimar"
                className=" duration-150 hover:bg-[#C778DD33] border border-[#C778DD] px-4 py-2 text-white flex"
              >
                <button className="flex justify-center items-center gap-2">
                  <img src="/pdf.svg" alt="" className="w-[32px]" />
                  Descargar CV
                </button>
              </a>
              <div className="flex">
                <a
                  ...
                  href="https://www.linkedin.com/in/jcastrolopez"
                >
                  <div className="w-12">
                ...
                <a
                  ...
                  rel="noreferrer"
                  className="about-icon"
                  href="https://github.com/devjclopez"
                >
                  <div className="w-12">
                    <svg viewBox="0 0 24 24" fill="none">
                      <g id="SVGRepo_iconCarrier">
              ...
              <a
                rel="noreferrer"
                className="about-icon flex gap-1 items-center"
                href="mailto:dev.jclopez@gmail.com"
              >
                <div className="w-10">
                  <svg
